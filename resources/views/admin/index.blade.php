                        ...
                        <div class="p-3 bg-white my-3">
                            ...
                            <div class="collapse " id="emp5">
                                            ...
                                            <div class="row py-2 border-bottom border-2 border-start-0 border-end-0 border-top-0">
                                                <div class="col-8 d-flex justify-content-between border-0 smaTxt ">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <a href="{{env('APP_URL')}}admin/attendance/full_report/{{$ka->id}}">
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                                <div class="col-4 text-start smText">
                                                    <a href="{{env('APP_URL')}}admin/attendance/full_report/{{$ka->id}}"><span class="m-0 vsmatxt fontmed">{{$ka->user_id}}</span></a>
                                                </div>
                                ...
                                <div class="row justify-content-around ">
                                    <a href="{{env('APP_URL')}}/admin/attendance" class="col-6 d-flex justify-content-between align-items-center baseBtnBg rounded p-2 my-2">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="names mb-0 dglo vsmatxt" style="max-height: 166px;overflow-y: auto; overflow-x:clip;">
                                            ...
                                            <div class=" px-2 fw-bold py-2">
                                                <p class="text-truncate position-relative ps-3 "> <span class="position-absolute  top-50 {{ $userId }}" id="" style="height: 5px;width: 5px;left: 7px;border-radius: 50%;transform: translateX(-50%);"></span> <a class="text-black text-decoration-none" href="{{env('APP_URL')}}admin/attendance/full_report/{{$member['id']}}"> {{ $member['name'] }} </a></p>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="col-8 my-3">
                                <div class=" bg-white p-3">
                                    <div class="d-flex align-items-center"> <i class="fa-solid fa-bell smText bibr baseBtnBg text-center rounded-circle text-white p-1 mx-1"></i>
                                        ...
                                        <a href="https://hr.pantheondigitals.com/admin/leave" class="col-4 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="row py-2 border-bottom border-2 border-start-0 border-end-0 border-top-0">
                                            ...
                                            <div class="col-3 d-flex justify-content-between border-0 smaTxt ">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <center>
                                                        <a href="https://hr.pantheondigitals.com/admin/leave_approve/{{$leave->id}}">
                                                            <i class="bi bi-check text-success SubHeding"></i>
                                                        </a>
                                                        <a href="https://hr.pantheondigitals.com/admin/leave_reject/{{$leave->id}}"><i class="bi bi-x SubHeding text-danger"></i></a>
                                                    </center>
                                                </div>
                                            </div>
                                        </div>
