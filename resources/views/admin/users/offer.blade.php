    ...
    <div id="page-container">
        <div id="pf1" class="pf w0 h0" data-page-no="1" style="background:#e7ebf8;">
            <div style="position: relative; border: 1px solid;">
                ...
                <div class="position-absolute top-0 p-5 my-3">
                    <div class="row">
                        ...
                        <p style="font-weight:700">Dear {{ucwords(strtolower($ext['fname']))}},</p>
                            <p> Pantheon Digital is pleased to offer you a position as "{{ucwords(strtolower($ext['position']))}}" and as discussed, your date of joining will be on {{$ext['jdate']}}. Your background, expertise and interests would aid us immensely in the pursuit of our company objectives.</p>
                            <p>We seek your assistance in building a world-class international enterprise, with unprecedented
                                scope, geographic coverage and quality of service, dedicated to the provision of a broad range
                                of information technology services to corporate and government accounts.</p>
                        
                            <p><span style="font-weight:700">Placement & Compensation:</span> You will be placed in the appropriate responsibility level of
                                the company and will be entitled to compensation (salary and other applicable benefits) as detailed in the Annexure. Compensation will be governed by the rules of the company on the subject,
                                as applicable and/or amended hereafter.</p>
                        
                            <p> <span style="font-weight:700">Probationary period:</span> You will be on probation for 90 days after which you will be
                                confirmed in writing, subject to your satisfactory performance, based on performance, this
                                probation period may be further extended, at the discretion of the company, in case of failure
                                the company can terminate you in between the probation period.</p>
                        
                            <p><span style="font-weight:700">Notice of Termination:</span> In the event either the company or the employee wishes to terminate
                                the employment, 7 days’ notice during probation or 30 days’ notice post confirmation in
                                writing from either side will be required. However, in case if the company wishes to terminate
                                the contract of employment, it may to do so at its sole. In case of absconding the company is not liable to pay to the employee.
                            </p>
                            <p class="mt-3">The company may terminate you anytime in case you do something unethical or
                                anything which goes against the
                                company rules and norms.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="position-absolute top-0 p-5 my-3">
                    <div class="row">
                        <div class="col-12 mt-4 text-center">
                            <span style="font-size: 12px;" ><span style="color:#1176bd;border-bottom:1px solid #1176bd;" class="fw-bold">ANNEXURE :</span> <span class="fw-bold" style="border-bottom:1px solid black;">Compensation Details(Salary & Applicable Benefits)</span>
                            <p>Your total salary/ CTC will be <span class="fw-bold"> INR. {{$sal}} (INR.{{ucwords(strtolower($salary_in_word))}} Only)</span> per annum.</span></p>
                        </div>
                        <div class="col-12">
                            <div class="col-12 py-1 my-3" style="border-bottom: 1px solid black; border-top:1px solid black;" >
                                ...
                                <p class="fw-bold" style="width:65px;">Name</p> <p>: {{ucwords(strtolower($ext['fname']))}} {{ucwords(strtolower($ext['lname']))}}</p></div>
                                <div class="mb-0 d-flex"><p class="fw-bold">Designation </p><p>: {{ucwords(strtolower($ext['position']))}}</p></div>
                        ...
                        <div class="col-8">
                            <p id="sign" >{{$ext['sign']}}</p>
                            <p>{{ucwords(strtolower($ext['sign_deg']))}}</p>
                        </div>
...
">
    ...
    WebFont.load({
        ...
        active: function() {
            // Font is active, now you can generate the PDF
            demoFromHTML();
        }
    });
});
