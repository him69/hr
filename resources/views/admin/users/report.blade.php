            ...
            <div class="app-main__inner">
                <nav class="row gx-0 m-0 my-2 px-2 justify-content-between">
                    <div class="nav justify-content-around nav-tabs d-flex gx-0 m-0 border-0" id="nav-tab" role="tablist" style="border-bottom: 1px solid;">
                        ...
                        <a class="nav-link text-center" href="{{env('APP_URL')}}admin/user_mode/{{$id}}" target="_blank">
                            view Dashboard
                        </a>
                    ...
                    <div class="col-4 row  justify-content-end ">
                        ...
                        <!-- <a class="p-2 col-3 baseBtnBg col-6 border-0 rounded text-center text-white" href="{{env('APP_URL')}}admin/user_mode/{{$id}}" target="_blank">
                            view Dashboard
                        </a> -->
                    ...
                    <div class="borderRadius baseShadow bg-white my-2 mx-auto p-2">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-bordered table-sm">
                                ...
                                @while($mte < explode('-',$us->mark_date)[2])
                                    <tr @if($us->mark == 'Sun') style="background:#c0c0c0; color:#000;"
                                        @endif><form action="{{env('APP_URL')}}admin/attendance/qa_full_report/{{$us->user_id}}" method="post" target="_blank">
                                            @csrf
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-hover table-bordered table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>{{$leave->reason}}</td>
                                    <td>@if($leave->approved == 0) <a href="{{env('APP_URL')}}admin/leave_approve/{{$leave->id}}" class="btn btn-success">Approve</a> @else <button class="btn btn-default" disabled>Approved</button> @endif</td>
                                </tr>
                                @endforeach
                                @else
                                <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header flex-column bg-white SubHeding border-0">
                ...
                <form action="{{env('APP_URL')}}admin/save_profile/{{$id}}" method="post" class="w-100">
                    @csrf
                    <div class="modal-body">
                        <div class="d-flex flex-column ">
