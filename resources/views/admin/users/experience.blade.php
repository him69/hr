    ...
    <div id="page-container">
        <div id="pf1" class="pf w0 h0" data-page-no="1" style="background:#e7ebf8;">
			...
			<div class="position-absolute top-0 sheet1">
				<p class="fs-6 my-3  fw-bold text-center">Experience Letter</p>
                    <div class="d-flex justify-content-between align-items-center my-5 pt-3">
                        <div>
                            <p>{{ $ext['address'] }}</p>
                        </div>
                        <div>
                            <p class="">Date: {{ $ext['date'] }}</p>
                        </div>
                    </div>
                    <div>
                        <p>
                    ...
                    <div>
                        <p>
                            This is to certify that {{ $ext['fname'] }} {{ $ext['lname'] }} has worked with Pantheon
                            Digital Pvt. Ltd.
                            as a {{ $ext['position'] }} from {{ $ext['fdate'] }} to {{ $ext['tdate'] }}. During this
                            period, @if ($ext['gender'] == 'He')
                                {{ 'he' }}@else{{ 'she' }}
                                @endif has diligently performed @if ($ext['gender'] == 'He')
                                    {{ 'his' }}@else{{ 'her' }}
                                @endif duties and responsibilities to the
                                best of @if ($ext['gender'] == 'He')
                                    {{ 'his' }}@else{{ 'her' }}
                                @endif abilities.
                        </p>
                        <p>
                            Based on our records and evaluations, {{ $ext['fname'] }} has completed all
                            formalities and obligations associated with @if ($ext['gender'] == 'He')
                                {{ 'his' }}@else{{ 'her' }}
                            @endif position.
                        </p>
                        <p>
                            During @if ($ext['gender'] == 'He')
                                {{ 'his' }}@else{{ 'her' }}
                            @endif tenure with us, {{ $ext['fname'] }} demonstrated commendable
                            professionalism, dedication, and competence in @if ($ext['gender'] == 'He')
                                {{ 'his' }}@else{{ 'her' }}
                            @endif role.
                        </p>
                        <P>
                            We hereby accept @if ($ext['gender'] == 'He')
                                {{ 'his' }}@else{{ 'her' }}
                                @endif resignation and relieve @if ($ext['gender'] == 'He')
                                    {{ 'him' }}@else{{ 'her' }}
                                    @endif from @if ($ext['gender'] == 'He')
                                        {{ 'his' }}@else{{ 'her' }}
                                    @endif duties
                                    with effect from {{ $ext['tdate'] }}.
                        </P>
                        <p>
                            We found {{ $ext['fname'] }} to be an asset to our team and organization, and
                            @if ($ext['gender'] == 'He')
                                {{ 'he' }}@else{{ 'she' }}
                                @endif will be missed. We wish @if ($ext['gender'] == 'He')
                                    {{ 'him' }}@else{{ 'her' }}
                                    @endif all the success in @if ($ext['gender'] == 'He')
                                        {{ 'his' }}@else{{ 'her' }}
                                    @endif future
                                    endeavours.
                        </p>
					...
					<div class="row">
						<div class="col-12">
                            ...
                            <p style="font-weight:700;font-size: 13px;">Pantheon Digital Pvt. Ltd.</p>
                        </div>
                        <div class="col-8 d-flex  justify-content-between">
                            <p id="sign" class="sing" >{{$ext['sign']}} </p>
