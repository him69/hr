                ...
                <div class="container ">
                    <div class="row ">
                        <div class="col-7 text-end">
                            <p class="h2 fw-bold text-end">My Attendance</p>
                        </div>
                        <div class="col-4  ms-auto d-flex justify-content-end">
                            <form method="post">@csrf
                                <div class="d-flex p-0 justify-content-center rounded-2">
                                    <div class="col-8 borderr bg-white">
                        ...
                        <div class="col-12">
                            <div class="borderRadius baseShadow m-auto my-2">
                                    ...
                                    <table class="table table-striped">
                                        <thead style="background-color:#EEFAFB;">
                                            ...
                                            <th class="text-center">
                                                <p class="para fw-bold">Date</p> <span
                                                    class="text-secondary fw-bold"  style="font-size:13px;"> (DD / MM / YYYY) </span>
                                            </th>
                                            <th class="text-center">
                                                <p class="para fw-bold">Login Time</p><span
                                                    class="text-secondary fw-bold" style="font-size:13px;"> (HH : MM) </span>
                                            </th>
                                            <th class="text-center">
                                            ...
                                            @if($user->user_type == 1)
                                            <th class="text-center">
                                                <p class="para fw-bold">Total Time</p> <span
                                                    class="text-secondary fw-bold" style="font-size:13px;">
                                                    (HH :
                                                    MM) </span>
                                            </th>
                                            <th class="text-center">
                                        ...
                                        @while($mte < $day) <?php $sd=$date."-".str_pad($mte, 2, "0" , STR_PAD_LEFT);
                                            $hddate=date_create($sd); $hda=date_format($hddate,"Y-m-d");
                                            $timestamp=strtotime(''.$sd.''); $sday=date('D', $timestamp); ?>
                                            @if($sday == 'Sun')
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center text-secondary smaTxt" style="@if(strtotime("
                                                    11:15") < strtotime($at['login_time'])){{'color:red;'}}@endif">
                                                    {{$at['login_time']}}</th>
