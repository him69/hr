                ...
                <div class="row">
                    <div class="col-7 d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <a href="{{env('APP_URL')}}adper/user_mode/{{$id}}" class="btn btn-group align-items-center px-2 py-1 baseShadow rounded-pill bg-white m-2" target="_blank">
