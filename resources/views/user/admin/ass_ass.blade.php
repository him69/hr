            ...
            <div class="tab-content " id=" nav-tabContent" style=" margin-top: -8px;">
              <div class="tab-pane fade m-auto mb-0 " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="borderRadius overflow-hidden baseShadow bg-white my-2 mx-auto px-3 py-3" style="width: 98%; ">
                  ...
                  <form method="POST" action="{{env('APP_URL')}}adper/ass_ass" enctype="multipart/form-data">
                    @CSRF
                    <div class="row">
                      <div class="col-12">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{{env('APP_URL')}}adper/resolved/{{$assets->id}}" class="mx-2">
                            Move Back to Assets
                          </a>
                        </td>
                      </tr>
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="p-4 w-50 mx-auto" style="border: 5px dashed #dee2e6; border-radius: 12px;">
          <form action="{{env('APP_URL')}}adper/bulkUpload" method="POST" enctype="multipart/form-data" class="row">
  ...
  <div class="offcanvas-body">
    ...
    <div class="tab-content" id="pills-tabContent">
      <div class="tab-pane fade " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        ...
        <form method="POST" action="{{env('APP_URL')}}adper/ass_ass">
          @CSRF
...
<script>
  ...
  async function fatchdata(e) {
    ...
    await fetch('{{env('APP_URL')}}adper/ass_ass/' + ass_id).then(Response => Response.json()).then(data => {
      ...
      if (data.status == 'assign') {
        ...
        document.getElementById('munass').href = '{{env('APP_URL')}}adper/unassigend/' + data.id + '/' + data.uid;
  ...
  function Filter(e) {
    ...
    fetch('{{env('APP_URL')}}adper/filter/?' + fill_type + '=' + val).then(Response => Response.json()).then(data => {
      // console.log(data);
      // console.log(data);
      updateTable(data);
    })
  ...
  function getall() {
    ...
    // console.log(val);  
    // console.log(fill_type);
    fetch('{{env('APP_URL')}}adper/getall/').then(Response => Response.json()).then(data => {
      // console.log(data);
      updateTable(data);
    })
  }
  ...
  async function get_history() {
    ...
    await fetch('{{env('APP_URL')}}adper/asset_history/' + id)
