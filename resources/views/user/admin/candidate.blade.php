                                ...
                                <div class="tabinfo" id="table1" style="display: block;">
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-center"><a class="btn" href="{{env('APP_URL')}}adper/reject/{{$us->id}}" value="rejected" name="reject" style="color:white;background-color: rgb(250, 68, 44); cursor:pointer;">Reject</a>
                                                </p>
                                            </td>
                                            @endif
                                        </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center flex-column align-items-center">
                    ...
                    <form action="{{env('APP_URL')}}adper/schedule" method="post">@csrf
